// Public API for PocketFlow REST client.
//
// This library exposes a thin, typed Dio-based client for the PocketFlow backend
// (see `10_api_spec.md`). All DTOs are hand-rolled (no build_runner) and all
// network errors are mapped to [Failure] subclasses from `pf_domain`.
