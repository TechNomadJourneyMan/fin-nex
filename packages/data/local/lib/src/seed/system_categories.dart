...
class SystemCategoriesSeed {
  ...
  static List<CategoryRow> all() => <CategoryRow>[
        // Basic expense (10)
        _row('food_groceries', 'expense', 'Продукты', 'shopping_cart', '#22C55E',
        ...
        _row('transport_car_service', 'expense',
            'Авто: сервис, страховка', 'build_circle', '#6366F1',
        ...
        _row('shopping_marketplaces', 'expense',
            'Маркетплейсы', 'storefront', '#F59E0B',
        ...
        _row('entertainment_events', 'expense',
            'Кино, концерты, события', 'theater_comedy', '#F43F5E',
        ...
        _row('health_medical', 'expense',
            'Врачи, анализы, страховка', 'medical_services', '#059669',
        ...
        _row('kids', 'expense', 'Дети (садик, школа, секции)',
            'child_care', '#FB7185',
        ...
        _row('taxes_fees', 'expense', 'Налоги, штрафы, гос. услуги',
            'gavel', '#475569',
        ...
        _row('transfer_p2p', 'transfer', 'Переводы людям',
            'send_to_mobile', '#8B5CF6',
