// Segmented control widget for FinNex.

import 'package:flutter/material.dart';

import 'fnx_theme_ext.dart';

/// FinNex segmented control (2-4 options) for time ranges and similar.
class FnxSegmentedControl<T> extends StatelessWidget {
  /// Creates a segmented control.
  const FnxSegmentedControl({
    super.key,
