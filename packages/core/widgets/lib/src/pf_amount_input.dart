...
class PfAmountInput extends StatefulWidget {
  ...
  @override
  State<PfAmountInput> createState() => _PfAmountInputState();
}

class _PfAmountInputState extends State<PfAmountInput> {
  late int _value;
