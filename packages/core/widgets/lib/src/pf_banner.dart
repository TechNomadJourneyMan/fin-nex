// Inline banner widget for PocketFlow.
...
/// Inline PocketFlow banner.
class PfBanner extends StatelessWidget {
  /// Creates a banner.
  const PfBanner({
    super.key,
    required this.message,
    this.title,
    this.tone = PfBannerTone.info,
    this.actionLabel,
    this.onAction,
    this.onDismiss,
  });
  ...
  ({Color bg, Color fg, IconData icon}) _palette(PfSemanticColors c) {
    switch (tone) {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      liveRegion: tone == PfBannerTone.error || tone == PfBannerTone.warning,
      label: title ?? message,
      child: Container(
