// Dropdown / select wrapper for FinNex.

import 'package:flutter/material.dart';

import 'fnx_theme_ext.dart';

/// Generic option used by [FnxSelect].
class FnxSelectOption<T> {
  /// Creates a select option.
  const FnxSelectOption({required this.value, required this.label, this.icon});
...
class FnxSelect<T> extends StatelessWidget {
  /// Creates a select.
  const FnxSelect({
    super.key,
    required this.value,
  ...
  /// Available options.
  final List<FnxSelectOption<T>> options;
