...
class PfColors extends ThemeExtension<PfColors> {
  ...
  /// Indigo brand bumped to 100% HSV saturation for high-contrast themes
  /// (hue 231°, value preserved). Used as the brand color in
  /// [PfColors.lightHighContrast] / [PfColors.darkHighContrast].
  static const Color primaryHc = Color(0xFF0026FE);
  ...
  /// Pure black `#000000` — high-contrast text (light) / surface (dark).
  static const Color pureBlack = Color(0xFF000000);

  /// Alias of [pureBlack] used for high-contrast text roles.
  static const Color neutral900Black = pureBlack;
  ...
  /// Light high-contrast token bundle.
  ///
  /// Pure white surfaces, pure black text/borders, and a fully-saturated
  /// indigo brand ([primaryHc]). Built for users who enable the OS or
  /// in-app "high contrast" preference (WCAG AAA-leaning).
  static const PfColors lightHighContrast = PfColors(
    surfaceBackground: neutral0,
    surfaceDefault: neutral0,
    surfaceRaised: neutral0,
    surfaceSunken: neutral0,
    surfaceBrand: primaryHc,
    surfaceBrandSubtle: indigo50,
    textPrimary: neutral900Black,
    textSecondary: neutral900Black,
    textMuted: neutral900Black,
    textDisabled: neutral600,
    textBrand: primaryHc,
    textInverse: neutral0,
    textSuccess: neutral900Black,
    textError: errorLight,
    borderSubtle: neutral900Black,
    borderDefault: neutral900Black,
    borderStrong: neutral900Black,
    borderBrand: primaryHc,
    divider: neutral900Black,
    success: successLight,
    successSubtle: successSubtleLight,
    warning: warningLight,
    warningSubtle: warningSubtleLight,
  ...
  /// Dark high-contrast token bundle.
  ///
  /// Pure black surfaces, pure white text/borders, and a fully-saturated
  /// indigo brand ([primaryHc]).
  static const PfColors darkHighContrast = PfColors(
    surfaceBackground: pureBlack,
    surfaceDefault: pureBlack,
    surfaceRaised: pureBlack,
    surfaceSunken: pureBlack,
    surfaceBrand: primaryHc,
    surfaceBrandSubtle: indigo800,
    ...
    textDisabled: neutral400,
    textBrand: neutral0,
    textInverse: pureBlack,
    textSuccess: neutral0,
    textError: errorDark,
    borderSubtle: neutral0,
    borderDefault: neutral0,
    borderStrong: neutral0,
    borderBrand: neutral0,
    divider: neutral0,
    success: successDark,
    successSubtle: successSubtleDark,
    warning: warningDark,
