...
/// FinNex Material 3 theme builders.
///
/// Wire from `MaterialApp(theme: FnxTheme.light(), darkTheme: FnxTheme.dark())`.
/// Both builds embed the full FinNex token set as `ThemeExtension`s, so
/// widgets can read tokens with `Theme.of(context).extension<FnxColors>()`.
abstract final class FnxTheme {
  /// Build the light [ThemeData].
  static ThemeData light() => _build(
        brightness: Brightness.light,
        colors: FnxColors.light,
      );

  /// Build the dark [ThemeData].
  static ThemeData dark() => _build(
        brightness: Brightness.dark,
        colors: FnxColors.dark,
      );

  static ThemeData _build({
    required Brightness brightness,
    required FnxColors colors,
  }) {
    final bool isDark = brightness == Brightness.dark;
    final FnxTypography typography = const FnxTypography();

    final ColorScheme scheme = ColorScheme(
      brightness: brightness,
      primary: FnxColors.primary500,
      onPrimary: FnxColors.neutral0,
      primaryContainer:
          isDark ? FnxColors.indigo800 : FnxColors.indigo50,
      onPrimaryContainer:
          isDark ? FnxColors.indigo100 : FnxColors.indigo700,
      secondary: FnxColors.mint500,
      onSecondary: FnxColors.neutral900,
      secondaryContainer:
          isDark ? FnxColors.successSubtleDark : FnxColors.mint100,
      onSecondaryContainer:
          isDark ? FnxColors.mint500 : FnxColors.mint600,
      tertiary: FnxColors.coral500,
      onTertiary: FnxColors.neutral0,
      tertiaryContainer:
          isDark ? FnxColors.errorSubtleDark : FnxColors.coral100,
      onTertiaryContainer:
          isDark ? FnxColors.coral500 : FnxColors.coral500,
      error: colors.error,
      onError: FnxColors.neutral0,
      ...
      surfaceTint: FnxColors.primary500,
      onSurfaceVariant: colors.textSecondary,
      outline: colors.borderDefault,
      outlineVariant: colors.borderSubtle,
      shadow: const Color(0xFF000000),
      scrim: const Color(0xFF000000),
      inverseSurface: isDark ? FnxColors.neutral50 : FnxColors.neutral900,
      onInverseSurface:
          isDark ? FnxColors.neutral900 : FnxColors.neutral50,
      inversePrimary:
          isDark ? FnxColors.indigo600 : FnxColors.indigo300,
    );
    ...
    return ThemeData(
      ...
      filledButtonTheme: FilledButtonThemeData(
        style: FilledButton.styleFrom(
          backgroundColor: FnxColors.primary500,
          foregroundColor: FnxColors.neutral0,
          ...
          shape: const RoundedRectangleBorder(borderRadius: FnxRadius.lg),
        ),
      ),
      ...
      chipTheme: ChipThemeData(
        ...
        padding: const EdgeInsets.symmetric(
          horizontal: FnxSpacing.x3,
          vertical: FnxSpacing.x1,
        ),
        shape: const RoundedRectangleBorder(borderRadius: FnxRadius.pill),
        side: BorderSide(color: colors.borderSubtle),
      ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: typography.bodyM.copyWith(
          color: isDark ? FnxColors.neutral900 : FnxColors.neutral0,
        ),
        actionTextColor: FnxColors.indigo300,
        behavior: SnackBarBehavior.floating,
        shape: const RoundedRectangleBorder(borderRadius: FnxRadius.md),
      ),
      ...
      progressIndicatorTheme: const ProgressIndicatorThemeData(
        color: FnxColors.primary500,
        linearTrackColor: FnxColors.neutral200,
      ),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        shape: const RoundedRectangleBorder(borderRadius: FnxRadius.sm),
      ),
      ...
      tooltipTheme: TooltipThemeData(
        decoration: BoxDecoration(
          color: isDark ? FnxColors.neutral50 : FnxColors.neutral900,
          borderRadius: FnxRadius.sm,
        ),
